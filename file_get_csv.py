...
class FileGetCsv():
    ...
    def import_categories_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('categories','categories.csv')
    ...
    def import_customer_customer_demo_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('customer_customer_demo','customer_customer_demo.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_customer_demographics_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('customer_demographics','customer_demographics.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_customers_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('customers','customers.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_employee_territories_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('employee_territories','employee_territories.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_employees_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('employees','employees.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_orders_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('orders','orders.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_products_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('products','products.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_region_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('region','region.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_shippers_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('shippers','shippers.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_suppliers_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('suppliers','suppliers.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_territories_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('territories','territories.csv')
       df.to_csv(str_date, index = False, header=True)
    ...
    def import_us_states_csv(self):
       ...
       str_date = self.CheckFolder.check_folder_csv('us_states','us_states.csv')
       df.to_csv(str_date, index = False, header=True)
